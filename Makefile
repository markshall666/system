...
lib:
	g++ -fPIC -c src/libCaller.cpp src/libFactory.cpp src/itc.cpp -Iinc -pthread
	g++ -shared -pthread -Wl,-soname,extLib.so.1 -o extLib.so.1.0.1 libCaller.o libFactory.o itc.o
links: 
